...
const seedData = async () => {
  try {
    ...
    const admins = [
      {
        email: 'admin@qbitworks.com',
        password: hashedPassword,
        name: 'Admin User',
        role: 'admin'
      },
      {
        email: 'super@qbitworks.com',
    ...
    console.log('   - Email: admin@qbitworks.com | Password: admin123');
    console.log('   - Email: super@qbitworks.com | Password: super123\n');
    ...
    const projectsData = [
      {
        ...
        link: 'https://github.com/qbitworks/ecommerce-platform',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/task-manager',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/healthcare-portal',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/financial-dashboard',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/social-analytics',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/lms-platform',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/iot-dashboard',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/restaurant-manager',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/real-estate',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/fitness-tracker',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/inventory-system',
      ...
      },
      {
        ...
        link: 'https://github.com/qbitworks/video-platform',
    ...
    const settingsData = {
      contactEmail: 'contact@qbitworks.com',
      contactPhone: '+1 (555) 123-4567',
      contactAddress: '123 Tech Street, Silicon Valley, CA 94025',
      socialLinks: {
        facebook: 'https://facebook.com/qbitworks',
        twitter: 'https://twitter.com/qbitworks',
        linkedin: 'https://linkedin.com/company/qbitworks',
        github: 'https://github.com/qbitworks',
        instagram: 'https://instagram.com/qbitworks'
      },
      emailNotifications: {
        enabled: true,
        recipientEmails: ['admin@qbitworks.com', 'contact@qbitworks.com']
      },
      autoReplyMessage: 'Thank you for contacting QBit Works! We have received your message and will respond within 24 hours. For urgent matters, please call us directly.',
